...
public class color2 extends JFrame {
    ...
    class Runner1 implements Runnable {
        ...
        private void processImg() {
            ...
            if (!pro) {
                try {
                    ImageIO.write(img, "JPEG", new FileOutputStream("C:\\Project\\IDProject\\color\\out\\o" + (int) (Math.random() * 10000) + ".jpg"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            } else {
                try {
                    ImageIO.write(img, "JPEG", new FileOutputStream("C:\\Project\\IDProject\\color\\out\\g" + times + ".jpg"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
